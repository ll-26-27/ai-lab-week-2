  ...
  return (
    <>
      <header className="site-header">
        <Link className="wordmark" href="/">tdm155ai <span>week 2</span></Link>
      ...
      <div className="content-shell">
        ...
        <main id="main" className="content-main">
          ...
          <header className="page-heading">
            <p className="eyebrow">Week 02 / {doc ? "Reading" : "Collection"}</p>
            <h1>{title}</h1>
      ...
      <footer className="site-footer"><Link href="/">TDM155AI · Week 2</Link><span>Tools of the AI trade</span></footer>
    </>
  );
}
